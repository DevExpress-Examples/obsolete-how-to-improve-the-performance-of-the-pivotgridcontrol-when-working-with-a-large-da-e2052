...
Namespace Q248188
	...
	Partial Public Class nwindDataSet
		...
		Partial Public Class SalesPersonDataTable
			...
			<Global.System.Diagnostics.DebuggerNonUserCodeAttribute()> _
			Public Function AddSalesPersonRow(ByVal Country As String, ByVal ProductName As String, ByVal CategoryName As String, ByVal UnitPrice As Decimal, ByVal Quantity As Short, ByVal Discount As Single, ByVal Extended_Price As Decimal, ByVal Sales_Person As String) As SalesPersonRow
				Dim rowSalesPersonRow As SalesPersonRow = (CType(Me.NewRow(), SalesPersonRow))
				Dim columnValuesArray() As Object = { Country, ProductName, CategoryName, UnitPrice, Quantity, Discount, Extended_Price, Sales_Person}
	...
	End Class
End Namespace
Namespace Q248188.nwindDataSetTableAdapters
	...
	Partial Public Class SalesPersonTableAdapter
		...
		Private Sub InitCommandCollection()
			...
			Me._commandCollection(0).CommandText = "SELECT Country, ProductName, CategoryName, UnitPrice, Quantity, Discount, [Extend" & "ed Price], [Sales Person] FROM SalesPerson"
